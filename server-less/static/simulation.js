...
class RungeKutta {
    ...
    calculatePoints() {
        ...
        let deltaPrey = (k1Prey + 2 * k2Prey + 2 * k3Prey + k4Prey) / 6;
        let deltaPred = (k1Pred + 2 * k2Pred + 2 * k3Pred + k4Pred) / 6;

        results.push([time, currentPrey, deltaPrey, currentPred, deltaPred]);
        ...
        while (time < this.finalTime) {
            ...
            deltaPrey = (k1Prey + 2 * k2Prey + 2 * k3Prey + k4Prey) / 6;
            deltaPred = (k1Pred + 2 * k2Pred + 2 * k3Pred + k4Pred) / 6;
